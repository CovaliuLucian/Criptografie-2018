...
public class DES
{
    ...
    public static String f(String mi, String key)
    {
        ...
        for (int aP : p)
        {
            mergedP = mergedP + merged.charAt(aP - 1);
        }
    ...
    public String encrypt(String key, String plaintext)
    {
        ...
        for (String binCiphertextBlock : binCiphertextBlocks) binCiphertext.append(binCiphertextBlock);
    ...
    void buildKeySchedule(long key)
    {
        ...
        for (int aPC1 : PC1) binKey_PC1 = binKey_PC1 + binKey.charAt(aPC1 - 1);
        ...
        for (int i = 1; i < K.length; i++)
        {
            ...
            for (int aPC2 : PC2) binKey_PC2 = binKey_PC2 + sMerged.charAt(aPC2 - 1);
